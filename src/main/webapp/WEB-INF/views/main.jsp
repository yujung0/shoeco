...
<%@include file="./include/header.jsp" %>
    ...
    <!-- Start Banner Hero -->
    <div id="template-mo-ShoeCo-hero-carousel" class="carousel slide" data-bs-ride="carousel">
        <ol class="carousel-indicators">
            <li data-bs-target="#template-mo-ShoeCo-hero-carousel" data-bs-slide-to="0" class="active"></li>
            <li data-bs-target="#template-mo-ShoeCo-hero-carousel" data-bs-slide-to="1" class=""></li>
            <li data-bs-target="#template-mo-ShoeCo-hero-carousel" data-bs-slide-to="2" class=""></li>
        </ol>
                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
                                ...
                                <p>
                                    You are permitted to use this ShoeCo CSS template for your commercial websites. 
        ...
        <a class="carousel-control-prev text-decoration-none w-auto ps-3" href="#template-mo-ShoeCo-hero-carousel" role="button" data-bs-slide="prev">
            <i class="fas fa-chevron-left"></i>
        </a>
        <a class="carousel-control-next text-decoration-none w-auto pe-3" href="#template-mo-ShoeCo-hero-carousel" role="button" data-bs-slide="next">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    <h2 class="h2 text-success border-bottom pb-3 border-light logo">ShoeCo Shop</h2>
